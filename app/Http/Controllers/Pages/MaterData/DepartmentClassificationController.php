 ...
 *
 * Mỗi phòng ban tự khai bộ nhóm phân loại của phòng mình, dùng khi khai "Vật Tư Của Phòng".
 * Khác với phân loại ở Danh Mục Vật Tư Công Ty - cái đó mô tả bản chất vật tư và dùng chung
 * toàn công ty (xem App\Support\MaterialClassification).
 *
 * Màn hình luôn làm việc trên phòng ban đang chọn ở topNAV - department_id lấy từ session,
 * không cho chọn tay để tránh sửa nhầm sang phòng khác.
 *
 * Không có bước duyệt. Khoá (status_id = 0) thay cho xoá cứng.
 */
class DepartmentClassificationController extends Controller
{
    use RequiresChangeReason;

    private const TABLE = 'department_classification';

    private const LABEL = 'phân loại';
    ...
    public function index()
    {
        ...
        session()->put(['title' => 'DỮ LIỆU GỐC - PHÂN LOẠI']);

        return view('pages.materData.DepartmentClassification.list', [
            'datas' => $datas,

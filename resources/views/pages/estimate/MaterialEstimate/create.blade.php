    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="{{ $estIcon }}"></i> Lập Phiếu Dự Trù Vật Tư</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="note" rows="2" maxlength="500"
                            ...
                            placeholder="Ví dụ: Dự trù vật tư phục vụ kiểm nghiệm quý 4">{{ old('note') }}</textarea>
                        @if ($bag->has('note'))
                    ...
                    <div class="md-hint">
                        ...
                        một phiếu dự trù vật tư. Lưu xong hệ thống mở thẳng trang chi tiết để khai các vật tư
                        cần dự trù.
                    </div>
                </div>

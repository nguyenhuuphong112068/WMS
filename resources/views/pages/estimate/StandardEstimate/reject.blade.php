...
{{--
| Modal từ chối một phiếu dự trù chất chuẩn đang chờ ký. Người ký bắt buộc nhập lý do
| để phòng ban biết phải sửa gì trước khi trình ký lại. Id và mã phiếu do JS đổ vào khi
| bấm nút Từ chối (xem pages/estimate/shared/assets.blade.php).
--}}
<div class="modal fade md-modal" id="rejectModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fas fa-ban"></i> Từ Chối Phiếu Dự Trù Chất Chuẩn</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="reject_reason" rows="3" maxlength="500"
                            ...
                            placeholder="Ví dụ: Chuẩn chính đã còn tồn đủ dùng đến hết quý, chưa cần mua thêm"

{{--
| Modal xem lịch sử điều chỉnh của một phiếu sử dụng chất chuẩn.
| Nội dung nạp bằng JS (xem pages/export/shared/assets.blade.php) từ route
| pages.export.standardExport.history.
--}}

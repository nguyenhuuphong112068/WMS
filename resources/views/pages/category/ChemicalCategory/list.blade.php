...
@section('mainContent')
    ...
    <style>
        ...
        /* ==========================================================================
        |  Phần chữ đen + cỡ chữ *1.2 dùng chung cho mọi bảng (td/th/md-sub/small/
        |  md-tag/badge/md-empty/md-note) nay khai ở layout/css.blade.php, áp cho
        |  toàn bộ DataTables trong dự án. Ở đây chỉ còn các class ĐẶC THÙ của
        |  riêng trang Danh Mục - Hoá Chất (không tồn tại ở màn hình khác).
        ========================================================================== */

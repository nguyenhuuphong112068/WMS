{{--
| Modal xem lịch sử điều chỉnh của một phiếu nhập chất chuẩn.
| Nội dung nạp bằng JS (xem pages/import/shared/assets.blade.php) từ route
| pages.import.standardImport.history.
--}}

    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fas fa-edit"></i> Cập Nhật Tên Sản Phẩm</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>

            <form action="{{ route('pages.materData.productName.update') }}" method="POST" autocomplete="off">
                @csrf
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="edit_name" class="form-control" value="{{ old('name') }}"
                            placeholder="Ví dụ: Paracetamol 500mg, Amoxicillin 250mg..." required>

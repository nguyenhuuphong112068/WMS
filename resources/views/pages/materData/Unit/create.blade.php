                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="short_name" maxlength="100"
                            ...
                            value="{{ old('short_name') }}" placeholder="Ví dụ: kg, L, thùng" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" maxlength="255"
                            ...
                            value="{{ old('name') }}" placeholder="Ví dụ: Ki-lô-gam" required>
                        @if ($bag->has('name'))
                            <span class="md-error">{{ $bag->first('name') }}</span>
                        @endif
                    </div>

                    @include('pages.materData.Unit.conversionFields', ['bag' => $bag])

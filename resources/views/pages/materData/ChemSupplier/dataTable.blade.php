    ...
    <div class="md-page">
        ...
        <div class="md-hero">
            <div>
                ...
                <p>Khai báo danh mục nhà cung cấp dùng chung cho toàn hệ thống. Bản ghi phải được duyệt trước khi sử dụng.</p>
            </div>
            <div class="md-stats">
                        ...
                        <tbody>
                            @foreach ($datas as $row)
                                <tr>
                                    ...
                                    <td class="md-sub">{{ $row->address ?: '—' }}</td>
                                    <td>
                                        @if ($row->tax_no)
                                            <span class="md-tag">{{ $row->tax_no }}</span>
                                        @else

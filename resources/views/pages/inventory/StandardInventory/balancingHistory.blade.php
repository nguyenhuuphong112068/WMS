{{--
|--------------------------------------------------------------------------
| TỒN - LỊCH SỬ CÂN ĐỐI CỦA MỘT MÃ ỐNG CHUẨN
|--------------------------------------------------------------------------
| Mở bằng badge nhỏ ở góc trên bên phải nút "Cân đối" trên bảng tồn kho.
| Badge chỉ hiện khi mã ống chuẩn đã được cân đối ít nhất một lần, nội dung
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="md-hint">
                    ...
                    đối của một mã ống chuẩn vẫn bị chặn trong <b>±{{ $balancingMaxPercent }}%</b> số lượng nhập.

...
<div class="modal fade md-modal" id="internalExpiryModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('pages.inventory.standardInventory.internalExpiry') }}" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <small class="md-sub">Lấy từ Danh Mục Chất Chuẩn (hoặc cấu hình riêng của phòng).</small>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            @endif
                            <small class="md-sub">Với chất chuẩn thường là <b>ngày mở ống</b> / đưa vào sử dụng.</small>
                        </div>
                    ...
                    <div class="md-hint">
                        ...
                        Hạn dùng nội bộ = <b>ngày xác định + số tháng hạn dùng</b> của chất chuẩn trong Danh Mục. Nếu
                        cộng xong <b>vượt quá hạn của nhà sản xuất</b> thì lấy chính hạn nhà sản xuất. Chỉ chất chuẩn
                        có khai báo hạn dùng mặc định mới xác định được; xác định lại nhiều lần được, mọi lần đều lưu
                        trong Audit Trail.
                    </div>
                </div>

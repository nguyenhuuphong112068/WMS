...
return new class extends Migration
{
    ...
    {
        Schema::create('chemical_exports', function (Blueprint $table) {
            $table->id();
            ...
            $table->index('code', 'chemical_exports_code_index');
            $table->index('import_id', 'chemical_exports_import_id_index');
            $table->index('department_id', 'chemical_exports_department_id_index');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('chemical_exports');
    }
};

...
return new class extends Migration
{
    ...
    {
        Schema::create('chemical_estimates', function (Blueprint $table) {
            $table->id();
            ...
            $table->index('department_id', 'chemical_estimates_department_id_index');
            $table->index('app_status', 'chemical_estimates_app_status_index');
            $table->index(['year', 'month'], 'chemical_estimates_period_index');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('chemical_estimates');
    }
};

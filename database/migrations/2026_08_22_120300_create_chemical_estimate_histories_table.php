...
return new class extends Migration
{
    ...
    {
        Schema::create('chemical_estimate_histories', function (Blueprint $table) {
            $table->id();
            ...
            $table->index('estimate_list_id', 'chemical_estimate_histories_list_id_index');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('chemical_estimate_histories');
    }
};

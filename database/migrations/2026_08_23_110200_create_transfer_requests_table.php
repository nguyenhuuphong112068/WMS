...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('transfer_requests', function (Blueprint $table) {
            ...
            $table->index('department_id', 'transfer_requests_department_id_index');
            $table->index('to_department_id', 'transfer_requests_to_department_id_index');
            $table->index('export_id', 'transfer_requests_export_id_index');
        });
    }

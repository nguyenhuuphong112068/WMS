...
return new class extends Migration
{
    ...
    {
        Schema::create('chemical_balancings', function (Blueprint $table) {
            $table->id();
            ...
            $table->index('code', 'chemical_balancings_code_index');
            $table->index('import_id', 'chemical_balancings_import_id_index');
            $table->index('department_id', 'chemical_balancings_department_id_index');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('chemical_balancings');
    }
};

...
return new class extends Migration
{
    ...
    {
        Schema::create('chemical_estimate_item_amounts', function (Blueprint $table) {
            $table->id();
            ...
            $table->index('estimate_item_id', 'chemical_estimate_item_amounts_item_id_index');
            $table->index('for_month_year', 'chemical_estimate_item_amounts_period_index');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('chemical_estimate_item_amounts');
    }
};

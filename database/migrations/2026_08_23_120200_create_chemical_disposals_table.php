...
return new class extends Migration
{
    ...
    {
        Schema::create('chemical_disposals', function (Blueprint $table) {
            $table->id();
            ...
            $table->index('department_id', 'chemical_disposals_department_id_index');
            $table->index('app_status', 'chemical_disposals_app_status_index');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('chemical_disposals');
    }
};

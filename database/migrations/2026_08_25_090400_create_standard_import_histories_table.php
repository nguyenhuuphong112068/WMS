...
/**
 * NHẬP - LỊCH SỬ ĐIỀU CHỈNH PHIẾU NHẬP CHẤT CHUẨN
 *
 * Mỗi lần Thêm mới / Điều chỉnh / Khoá / Mở khoá một dòng ở standard_imports sẽ ghi
...
return new class extends Migration
{
    ...
    {
        Schema::create('standard_import_histories', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('coa_no', 100)->nullable();
            ...
            $table->index('standard_import_id', 'standard_import_histories_parent_index');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('standard_import_histories');
    }
};

...
return new class extends Migration
{
    ...
    {
        Schema::create('chemical_export_histories', function (Blueprint $table) {
            $table->id();
            ...
            $table->index('export_id', 'chemical_export_histories_export_id_index');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('chemical_export_histories');
    }
};

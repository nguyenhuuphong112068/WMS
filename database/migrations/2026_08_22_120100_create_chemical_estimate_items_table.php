...
return new class extends Migration
{
    ...
    {
        Schema::create('chemical_estimate_items', function (Blueprint $table) {
            $table->id();
            ...
            $table->index('estimate_list_id', 'chemical_estimate_items_estimate_list_id_index');
            $table->index('category_id', 'chemical_estimate_items_category_id_index');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('chemical_estimate_items');
    }
};
